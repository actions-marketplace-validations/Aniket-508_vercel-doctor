...
export const TestimonialAvatarImg = ({
  className,
  src,
  alt,
  ...props
...
export const TestimonialAvatarRing = ({
  className,
  ...props
}: ComponentProps<"div">) => (
  <div
...
export const TestimonialAuthorName = ({
  className,
  ...props
}: ComponentProps<"div">) => (
  <div
    data-slot="author-name"
    className={cn("text-foreground text-sm leading-4 font-semibold", className)}
    {...props}
  />
);

export const TestimonialAuthorTagline = ({
  className,
  ...props
}: ComponentProps<"div">) => (
  <div
...
export const TestimonialVerifiedBadge = ({
  className,
  ...props
}: ComponentProps<"svg">) => (
  <svg
